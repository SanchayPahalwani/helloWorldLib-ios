...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of helloWorldLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SanchayPahalwani/helloWorldLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SanchayPahalwani' => 'sanchay.pahalwani@gmail.com' }
  s.source           = { :git => 'https://github.com/SanchayPahalwani/helloWorldLib.git', :tag => s.version.to_s }
